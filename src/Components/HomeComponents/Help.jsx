...
const Help = () => {
  return (
    <React.Fragment>
      <div className="h-screen w-full px-40 bg-gradient-to-b md:flex flex-col hidden from-violet-100 via-slate-50 to-slate-50">
        <h1 className="text-3xl font-semibold pt-10 text-left">
        ...
        <div className="flex flex-row px-14">
          <div className="bg-white w-80 h-52 hover:w-96 duration-300 mt-10 rounded-lg shadow">
            <h1 className="font-semibold pl-6 pt-2 text-left">
              Amazing Experience
            </h1>
            <h2 className="px-6 mt-6 text-left">
              It's been an amazing experience with Landflip. Prompt repayment
            ...
            ></img>
            <p className="ml-20 text-left text-gray-500 -mt-8 font-bold">
              Adelice Umuhoza
            </p>
          </div>
          {/* Second */}
          ...
          {/* Third */}
          <div className="bg-white w-80 h-52 hover:w-96 ml-12 duration-300 mt-10 rounded-lg shadow">
            <h1 className="font-semibold pl-6 pt-2 text-left">User-Friendly</h1>
            <h2 className="px-6 mt-6 text-left">
      ...
      {/* Mobile View*/}
      <div className=" w-full lg:hidden md:hidden px-10 bg-gradient-to-b from-violet-100 via-slate-50 to-slate-50">
        <h1 className="text-2xl font-semibold pt-10 text-left">
          We've helped many Nigerian<br></br> achieve financial freedom
        </h1>
        <img src={line} alt="line" className="w-48"></img>
        <div className="flex flex-col">
          <div className="mx-auto">
            <div className="bg-white w-96 h-52 mt-10 rounded-lg shadow">
              <h1 className="font-bold pl-6 pt-2 text-left">
                Amazing Experience
              </h1>
              <h2 className="px-6 mt-6 text-left">
                It's been an amazing experience with Landflip. Prompt repayment
            ...
            {/* Second */}
            <div className="bg-white w-96 h-52 duration-300 mt-10 rounded-lg shadow">
              <h1 className="font-bold text-left pl-6 pt-2">
                Easy & Secured Funding
              </h1>
              <h2 className="px-6 mt-6 text-left">
                I love how easy it is to fund your account with Landflip. It's
            ...
            {/* Third */}
            <div className="bg-white w-96 h-52  duration-300 mt-10 rounded-lg shadow">
              <h1 className="font-bold pl-6 pt-2 text-left">User-Friendly</h1>
              <h2 className="px-6 mt-6 text-left">
                Landflip has a very friendly user interface. The mobile app is
                just seamless and easy to use!
              </h2>
