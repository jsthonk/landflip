...
const Profiting = () => {
  return (
    <React.Fragment>
      <div className="h-screen w-full pt-10 text-black md:flex flex-col mt-28 bg-gradient-to-br from-violet-100 via-violet-50 to-violet-50 hidden">
            ...
            <div className="column">
              <div className="card">
                ...
                <h2 className="px-2 text-center mt-10 font-semibold">
                  In the past 12 months, the Ox-Invest team has acquired over
      ...
      {/* Mobile View */}
      <div className=" w-full pt-10 text-black flex flex-col mt-28 bg-gradient-to-br from-violet-100 via-violet-50 to-violet-50 md:hidden lg:hidden">
        <h1 className="text-center font-semibold text-3xl flex flex-col">
          We make profiting from lands
          <span className="mt-2">as easy as owning a land</span>
        </h1>
        <h2 className="text-center px-4 text-gray-500 mt-5 text-md">
          We give everyone equal opportunity to build wealth through real estate
          and landed properties. Whether you are buying or reselling, it is
          <span className="font-semibold ml-1">EASIER, FASTER, and SAFER </span>
          with us.
        </h2>
        <div className="mx-auto mt-10">
          <div className=" bg-slate-50 w-96 car rounded overflow-hidden">
            <div className="column">
              <div className="card">
                <img src={buy} className="-mt-5 object-cover" alt="text"></img>
                <h1 className="font-bold text-center text-2xl mt-2">
