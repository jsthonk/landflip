...
const OurLands = () => {
  ...
  return (
    <React.Fragment>
      <div className="w-full pt-10 px-40 md:flex flex-col hidden">
        ...
        <div name="Tabs" className="flex flex-col mt-10">
          <div name="TabsList" className="flex gap-8">
            <div name="TabsHead" onClick={() => setLandTabs(0)}>
              <h1 className="bg-gray-200 px-10 font-bold py-2 rounded">
                Lagos
              </h1>
            </div>
        ...
        <button className="bg-violet-900 text-white px-4 py-3 mx-auto w-56 rounded font-bold mb-10">
          <a
      ...
      {/* Mobile View*/}
      {/* Mobile View*/}
      <div className="w-full flex flex-col pt-10 lg:hidden md:hidden">
        <h1 className="text-left ml-2 font-bold text-3xl">
          Our Land Locations
        </h1>

        <div name="Tabs" className="flex flex-col mt-10">
          <div name="TabsList" className="flex gap-8 mx-auto">
            <div name="TabsHead" onClick={() => setLandTabs(0)}>
              <h1 className="bg-gray-200 px-10 font-bold py-2 rounded">
                Lagos
              </h1>
          ...
          <div name="TabsCOntents" hidden={landTabs !== 0}>
            <h1 className="text-left mt-6 ml-2 font-bold">
              Lagos Lands Locations
            </h1>
          ...
          {/* Abuja Lands */}
          <div name="TabsCOntents" hidden={landTabs !== 1}>
            <h1 className="text-left mt-10 font-bold ml-2">
              Abuja Lands Locations
            </h1>
            <div className="flex flex-col pb-10">
              <div className="mx-auto">
                {/* First column*/}
        ...
        <button className="bg-violet-900 text-white px-4 py-2 w-52 mx-auto rounded font-bold mb-10">
          <a
            href="https://dashboard.landflip.ng/"
            target="_blank"
            rel="noopener noreferrer"
